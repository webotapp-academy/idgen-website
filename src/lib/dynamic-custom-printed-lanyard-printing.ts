...
export * from "./dynamic-custom-printed-lanyard-printing-types";

const DATA_FILE_PATH = path.join(
  process.cwd(),
  "src",
  "data",
  "dynamic-custom-printed-lanyard-printing.json"
);
const LEGACY_DATA_FILE_PATH = path.join(
  process.cwd(),
  "data",
  "custom-printed-lanyard-printing.json"
);

export const DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA: DynamicCustomPrintedLanyardPrintingData = {
  hero: {
    badge: "Custom Printed Lanyard Printing",
    title: "Custom 20 mm Printed Lanyards",
    titleHighlight: "for ID Cards, Organizations & Events",
    description:
    ...
    workflowHeading: "A typical identification arrangement is:",
    workflowChain: ["ID Card", "Holder/Attachment", "Hook", "Custom Printed Lanyard"],
    workflowNote: "The exact attachment depends on the application.",
    primaryCtaText: "Request a Lanyard Quote",
    primaryCtaLink: "/request-a-quote/",
    secondaryCtaText: "View Lanyard Pricing",
  ...
  customElements: {
    eyebrow: "Custom Lanyard Specifications",
    title: "Lanyards can be customized with your organization branding",
    image: "/images/20mm-custom-printed-lanyard-branding.jpg",
    imageBadge: "High-Definition Print",
    imageWidthBadge: "20 mm",
    imageFooterSubtitle: "Continuous Dye Sublimation",
    imageFooterTitle: "Satin Polyester Ribbon",
    imageFooterTag: "IDGen",
    containerBadge: "Customizable Features",
    containerCount: "8 Parameters",
    containerIntro: "Lanyards can be customized with your:",
    elements: [
      "Organization logo",
      "Organization name",
      "Brand colours",
  ...
  whatIs: {
    eyebrow: "Identification Concept",
    title: "What Is Custom Printed Lanyard Printing?",
    description:
    ...
    arrangementHeading: "A typical identification arrangement is:",
    arrangementChain: ["ID Card", "Holder/Attachment", "Hook", "Custom Printed Lanyard"],
    arrangementNote: "The exact attachment depends on the application.",
  },
  suitableFor: {
  ...
  printableItems: {
    eyebrow: "Artwork Inclusions",
    title: "What Can Be Printed on a Lanyard?",
    intro: "Depending on the artwork, a custom lanyard may include:",
    items: [
      "Company logo",
      "School logo",
    ...
    footerNote: "The final artwork should be checked and approved before production.",
  },
  applicationCards: {
  ...
  lanyardSetup: {
    ...
    image: "/images/id-card-lanyard-holder-hook-setup.jpg",
    imageBadge: "Complete Setup",
    imageTag: "IDGen",
    imageFooterSubtitle: "Matching Identification",
    imageFooterTitle: "Card + Holder + Hook + Lanyard",
    imageFooterTag: "Ready to Wear",
    option1Heading: "Option 1",
    option1Chain: ["ID Card", "Holder", "Hook", "Lanyard"],
    option2Heading: "Option 2 (Ultrasonic Sealed)",
    option2Chain: ["ID Card", "Ultrasonic Sealing", "Holder", "Hook", "Lanyard"],
    note: "The correct configuration depends on the type of card, holder, attachment and intended use.",
    links: [
      { topic: "Explore ID Card Printing", href: "/id-card-printing/" },
      { topic: "Explore ID Card Holders", href: "/id-card-holders/" },
      { topic: "Explore ID Card Hooks", href: "/id-card-hooks/" },
      { topic: "Explore Ultrasonic Sealing", href: "/ultrasonic-sealing/" },
    ],
  },
  bulkOrders: {
    eyebrow: "Institutional Capacity",
    title: "Custom Lanyard Printing for Bulk Orders",
    description:
      "Custom lanyards are particularly useful when an organization needs consistent branding across a large group of people.",
    image: "/images/bulk-custom-lanyard-printing-idgen.jpg",
    imageBadge: "Factory Production",
    imageTag: "Bulk Orders",
    imageFooterSubtitle: "Quality Audited",
    imageFooterTitle: "Packaged for Immediate Dispatch",
    imageFooterTag: "Guwahati",
    requirementsTitle: "Typical bulk requirements include:",
    requirements: [
      "Student batches",
      "Employee batches",
    ...
    note: "For bulk orders, the quotation depends on the required quantity, specification, artwork and configuration.",
    ctaText: "Request a Bulk Lanyard Quote",
  ...
  designGuidelines: {
    ...
    title: "Custom Lanyard Design",
    description:
      "A good lanyard design should remain readable and visually consistent when repeated along the strap.",
    recommendedHeading: "Recommended Design Elements:",
    recommendedFormula: "Logo + Organization Name + Brand Pattern",
    guidelinesHeading: "Keep important elements:",
    guidelines: [
      "Clear",
  ...
  qualityConsiderations: {
    ...
    considerationsHeading: "Important considerations include:",
    factors: [
      "Lanyard width",
      "Printing quality",
      "Artwork accuracy",
  ...
  ultrasonicSealing: {
    eyebrow: "Finishing Option",
    title: "Ultrasonic Sealing With Lanyard Attachments",
    paragraph1:
    ...
    image: "/images/ultrasonic-sealed-lanyard-attachment.jpg",
    imageBadge: "Acoustic Fusion",
    imageTag: "Welded Loop",
    imageFooterSubtitle: "Smooth & Tear-Proof",
    imageFooterTitle: "Zero Metal Staples",
    imageFooterTag: "Guwahati",
    ctaText: "Learn About Ultrasonic Sealing",
  ...
  pricing: {
    ...
    title: "Custom Printed Lanyard Price",
    description:
    ...
    standardProductBadge: "Standard Product",
    standardProductName: "20 mm Custom Printed Lanyard",
    standardProductNote: "Subject to current quotation, quantity and applicable specifications.",
    price: "₹15",
    unit: "/ piece",
    ctaText: "View Current Lanyard Pricing",
    ctaLink: "/pricing/",
  },
  faq: {
  ...
  geographicDirectory: {
    ...
    title: "Direct ID Card & Lanyard Printing Services Across Northeast India",
    description:
...
export function getDynamicCustomPrintedLanyardPrinting(): DynamicCustomPrintedLanyardPrintingData {
  try {
    ...
    return {
      ...
      ...parsed,
      hero: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.hero,
        ...(parsed.hero || {}),
      },
      heroSlides:
        parsed.heroSlides && parsed.heroSlides.length > 0
          ? parsed.heroSlides
          : DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.heroSlides,
      customElements: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.customElements,
        ...(parsed.customElements || {}),
      },
      whatIs: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.whatIs,
        ...(parsed.whatIs || {}),
      },
      suitableFor: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.suitableFor,
        ...(parsed.suitableFor || {}),
      },
      printingOptions: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.printingOptions,
        ...(parsed.printingOptions || {}),
      },
      printableItems: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.printableItems,
        ...(parsed.printableItems || {}),
      },
      applicationCards: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.applicationCards,
        ...(parsed.applicationCards || {}),
      },
      lanyardSetup: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.lanyardSetup,
        ...(parsed.lanyardSetup || {}),
      },
      bulkOrders: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.bulkOrders,
        ...(parsed.bulkOrders || {}),
      },
      artworkProcess: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.artworkProcess,
        ...(parsed.artworkProcess || {}),
      },
      whyUseLanyards: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.whyUseLanyards,
        ...(parsed.whyUseLanyards || {}),
      },
      designGuidelines: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.designGuidelines,
        ...(parsed.designGuidelines || {}),
      },
      qualityConsiderations: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.qualityConsiderations,
        ...(parsed.qualityConsiderations || {}),
      },
      ultrasonicSealing: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.ultrasonicSealing,
        ...(parsed.ultrasonicSealing || {}),
      },
      completeConfigurations: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.completeConfigurations,
        ...(parsed.completeConfigurations || {}),
      },
      howToOrder: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.howToOrder,
        ...(parsed.howToOrder || {}),
      },
      pricing: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.pricing,
        ...(parsed.pricing || {}),
      },
      faq: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.faq,
        ...(parsed.faq || {}),
      },
      closingCta: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.closingCta,
        ...(parsed.closingCta || {}),
      },
      geographicDirectory: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.geographicDirectory,
        ...(parsed.geographicDirectory || {}),
      },
      metadata: {
        ...DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA.metadata,
        ...(parsed.metadata || {}),
      },
    };
  } catch (error) {
    console.error("Error reading custom-printed-lanyard-printing data:", error);
    return DEFAULT_CUSTOM_PRINTED_LANYARD_PRINTING_DATA;
  }
}

export function saveDynamicCustomPrintedLanyardPrinting(
