...
export * from "./dynamic-event-card-printing-types";

const DATA_FILE_PATH = path.join(
  process.cwd(),
  "src",
  "data",
  "dynamic-event-card-printing.json"
);

export const DEFAULT_EVENT_CARD_PRINTING_DATA: DynamicEventCardPrintingData = {
  hero: {
    badge: "Event Card Printing",
    title: "Custom Event Cards & Badges",
    titleHighlight: "for Conferences, Exhibitions, Seminars & Events",
    description:
    ...
    workflowHeading: "Event Identification Workflow:",
    workflowChain: [
      "Event Data",
      "Card Design",
      "Preview",
    ...
    primaryCtaText: "Request Event Card Quote",
    primaryCtaLink: "/request-a-quote/",
    secondaryCtaText: "View Event Card Pricing",
  ...
  whatIs: {
    ...
    attendeesHeading: "It can identify:",
    attendees: [
      "Participants",
      "Delegates",
      "Speakers",
  ...
  customFields: {
    ...
    fieldsHeading: "Available personalized card elements:",
    fields: [
      "Participant name",
      "Photograph",
      "Organization",
    ...
    specimen: {
      eyebrow: "Layout Specimen",
      structureTag: "Example Structure",
      eventLogoText: "EVENT LOGO",
      eventName: "ANNUAL BUSINESS CONFERENCE 2026",
      participantName: "SUMIT GUPTA",
      organization: "IDGen",
      categoryBadge: "DELEGATE",
      regNumber: "Registration No. 10254",
      footerNote: "The final information and design depend on the event requirements.",
    },
  },
  ...
  eventTypes: {
    ...
    types: [
      ...
      {
        title: "Exhibition & Trade Show Passes",
        body: "For expos, trade fairs, trade summits, and buyer-seller meets. Identification elements often distinguish exhibitors, visitors, organizers, and media.",
        iconName: "Building2",
      },
      {
        title: "Seminar & Workshop Badges",
        body: "For training programs, workshops, seminars, and corporate sessions. Can be produced with participant details, session details, and organizational logos.",
        iconName: "Store",
      },
      {
        title: "Corporate Event Cards",
        body: "For annual meets, product launches, corporate summits, board meetings, and dealer meetings. Reflects executive corporate branding and company identity.",
        iconName: "Building2",
      },
      {
        title: "Sports & Cultural Event Passes",
        body: "For sports tournaments, athletic meets, cultural festivals, youth festivals, and community celebrations with category-based access control.",
        iconName: "Trophy",
      },
      {
        title: "Institutional & School Events",
        body: "For university fests, inter-college competitions, science exhibitions, and academic Olympiads.",
        iconName: "School",
        href: "/student-id-card-printing/",
        linkText: "Explore Student ID Cards",
      },
    ],
  },
  ...
  attachment: {
    ...
    imageBadge: "Attachment Options",
    imageTag: "IDGen",
    imageFooterSubtitle: "1-Hook vs 2-Hook",
    imageFooterTitle: "Single vs Anti-Flip Dual Attachment",
    imageFooterTag: "Guwahati Hub",
    eyebrow: "Hardware Attachment",
    ...
    option1: {
      heading: "One-Hook Configuration",
      chain: ["Event Card", "One Hook", "Lanyard"],
      note: "This configuration may be suitable where the card has a single attachment point.",
    },
    option2: {
      heading: "Two-Hook Configuration",
      chain: ["Event Card", "Two Hooks", "Lanyard"],
      note: "This configuration can be used where the event card requires attachment at two points.",
    },
    note: "The correct configuration depends on the card design and attachment requirement.",
    links: [
      { topic: "Explore Custom Printed Lanyard Printing", href: "/custom-printed-lanyard-printing/" },
      { topic: "Explore ID Card Hooks", href: "/id-card-hooks/" },
    ],
  },

  ultrasonic: {
    eyebrow: "Acoustic Fusion",
    ...
    oneHookHeading: "One-Hook Event Setup",
    oneHookChain: ["Event Card", "One Hook", "One Ultrasonic Sealing Point", "Lanyard"],
    twoHookHeading: "Two-Hook Event Setup",
    twoHookChain: ["Event Card", "Two Hooks", "Two Ultrasonic Sealing Points", "Lanyard"],
    ctaText: "Explore Ultrasonic Sealing",
    ctaLink: "/ultrasonic-sealing/",
  },

  rightAttachment: {
    eyebrow: "Wearable Balance",
    title: "Why Event Cards Need the Right Attachment",
    description: "An event card is not only a printed badge. The final wearable setup depends on:",
    chain: ["Card Design", "Attachment Position", "Hook Configuration", "Lanyard"],
    note: "An incorrect attachment configuration can affect how the badge hangs or is worn. That is why IDGen can determine the appropriate configuration based on the event card design and customer requirements before production.",
  },
    ...
    categories: [
      {
        name: "Delegate",
        color:
          "border-blue-500/30 bg-blue-50/60 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300",
      },
      {
        name: "Speaker",
        color:
          "border-emerald-500/30 bg-emerald-50/60 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300",
      },
      {
        name: "Organizer",
        color:
          "border-amber-500/30 bg-amber-50/60 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300",
      },
      {
        name: "Staff",
        color:
          "border-purple-500/30 bg-purple-50/60 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300",
      },
      {
        name: "Exhibitor",
        color:
          "border-cyan-500/30 bg-cyan-50/60 dark:bg-cyan-950/40 text-cyan-700 dark:text-cyan-300",
      },
      {
        name: "Sponsor",
        color:
          "border-rose-500/30 bg-rose-50/60 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300",
      },
      {
        name: "VIP",
        color:
          "border-yellow-500/30 bg-yellow-50/60 dark:bg-yellow-950/40 text-yellow-700 dark:text-yellow-300",
      },
      {
        name: "Media",
        color:
          "border-indigo-500/30 bg-indigo-50/60 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300",
      },
      {
        name: "Volunteer",
        color:
          "border-teal-500/30 bg-teal-50/60 dark:bg-teal-950/40 text-teal-700 dark:text-teal-300",
      },
      {
        name: "Visitor",
        color:
          "border-slate-500/30 bg-slate-50/60 dark:bg-slate-900/60 text-slate-700 dark:text-slate-300",
      },
    ],
  },
  ...
  branding: {
    ...
    structureHeading: "Example Branding Structure",
    structureSteps: [
      "EVENT LOGO",
      "EVENT NAME",
      "PARTICIPANT NAME",
    ...
    structureNote: "The final design is prepared according to the approved event artwork.",
  },

  personalization: {
    eyebrow: "Data Ingestion",
    title: "Personalized Event Cards",
    description:
    ...
    note: "For larger events, the digital data workflow can be supported through IDGen Studio, where applicable.",
  ...
  bulk: {
    ...
    factorsHeading: "Bulk requirements evaluated by:",
    factors: [
  ...
  process: {
    ...
    steps: [
      {
        title: "01 - Requirement Discussion",
        body: "The event format, approximate quantity and required configuration are discussed.",
      },
      {
        title: "02 - Design Confirmation",
        body: "The event branding, card size and layout requirements are reviewed.",
      },
      {
        title: "03 - Participant Data Preparation",
        body: "Where personalization is required, participant data and photographs are organized.",
      },
      {
        title: "04 - Preview & Approval",
        body: "Sample previews of the card design and personalized data are verified before production.",
      },
      {
        title: "05 - Card Printing",
        body: "Cards are printed according to the approved specification and quantities.",
      },
      {
        title: "06 - Accessory Integration",
        body: "Lanyards, hooks and attachment accessories are assembled as per configuration.",
      },
      {
        title: "07 - Ultrasonic Sealing",
        body: "Where applicable, ultrasonic sealing is applied to the attachment points.",
      },
      {
  ...
  solutions: {
    ...
    solutions: [
      {
        type: "Conferences",
        setup: ["Event Card", "One Hook / Two Hooks", "Lanyard"],
        desc: "Professional presentation suitable for multi-day summits and academic symposiums.",
      },
      {
        type: "Exhibitions",
        setup: ["Exhibitor / Visitor Cards", "Lanyard", "Category Differentiation"],
        desc: "Clear visual role differentiation across bustling trade exhibition floors.",
      },
      {
        type: "Seminars",
        setup: ["Event Card", "Single Hook", "Branded Lanyard"],
        desc: "Clean, streamlined identification format for half-day or full-day educational sessions.",
      },
      {
        type: "Corporate Events",
        setup: ["Card", "Premium Lanyard", "Ultrasonic Sealing"],
        desc: "High-end corporate aesthetics with seamless welded seams for executive gatherings.",
      },
      {
        type: "Sports Events",
        setup: ["Durable Pass", "Anti-Twist Double Hook", "Lanyard"],
        desc: "Sturdy non-flipping credentialing suited for active tournament arenas and sidelines.",
      },
      {
        type: "Institutional Events",
        setup: ["Participant Badges", "Custom Ribbons", "Color Accents"],
        desc: "Cost-effective, branded badge systems for university, college, and school celebrations.",
      },
    ],
  },

  comparison: {
    eyebrow: "Comparative Purpose",
    title: "Event Card vs Student or Employee ID Card",
    description:
    ...
    items: [
      {
        ...
        setup: ["Event", "Participant", "Badge", "Lanyard"],
      },
      {
        type: "Student Identification",
        setup: ["Student", "Institution", "ID Card", "Holder/Lanyard"],
      },
      {
        type: "Employee Identification",
        setup: ["Employee", "Company", "ID Card", "Holder/Lanyard"],
      },
    ],
    footerNote:
      "If the requirement is an ongoing student or employee identification system, use the relevant dedicated service page.",
    links: [
      { label: "Student ID Card Printing", href: "/student-id-card-printing/" },
      { label: "Employee ID Card Printing", href: "/employee-id-card-printing/" },
    ],
  },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          "Lanyard requirement",
          "Ultrasonic sealing requirement",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        body: "Names, photographs and registration information are verified against database records.",
      },
      {
        title: "Artwork",
        body: "Event branding, contrast, and approved design alignments are inspected.",
      },
      {
        title: "Specifications",
        body: "Card size and required printing specifications match exact order details.",
      },
      {
        title: "Attachment",
        body: "Correct hook and lanyard configuration is checked for secure fit.",
      },
      {
        title: "Final Assembly",
        body: "Where applicable, the complete wearable setup is checked before dispatch.",
      },
    ],
  },
  ...
  pricing: {
    ...
    cta1Link: "/pricing/",
    cta2Text: "View Custom Printed Lanyard Pricing",
    cta2Link: "/pricing/",
    cta3Text: "View Ultrasonic Sealing Pricing",
    cta3Link: "/pricing/",
  },

  whyChoose: {
    eyebrow: "End-to-End Coordination",
    title: "Why Choose IDGen for Event Cards?",
    description:
    ...
    chain: [
      ...
      "Preview",
      "Card Printing",
      "Hook/Lanyard Configuration",
      "Sealing",
      "Quality Check",
      "Dispatch",
    ],
    note: "This allows event organizers to define the required identification setup before production instead of coordinating each component independently.",
    ctaText: "Request an Event Card Quote",
  ...
  summaryBanner: {
    eyebrow: "IDGen Event Card Printing",
    title: "Custom Event Identification for Conferences, Exhibitions & Events",
    chain: [
      "Data",
      "Design",
      "Preview",
  ...
  geographicDirectory: {
    ...
    title: "Event Card Printing in Guwahati, Assam & Across Northeast India",
    description:
    ...
    directoryHeading: "Related IDGen Solutions & Directories:",
    links: [
...
export function getDynamicEventCardPrinting(): DynamicEventCardPrintingData {
  try {
    ...
    return {
      ...
      ...parsed,
      hero: { ...DEFAULT_EVENT_CARD_PRINTING_DATA.hero, ...(parsed.hero || {}) },
      heroSlides:
        Array.isArray(parsed.heroSlides) && parsed.heroSlides.length > 0
          ? parsed.heroSlides
          : DEFAULT_EVENT_CARD_PRINTING_DATA.heroSlides,
      whatIs: { ...DEFAULT_EVENT_CARD_PRINTING_DATA.whatIs, ...(parsed.whatIs || {}) },
      customFields: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.customFields,
        ...(parsed.customFields || {}),
        specimen: {
          ...DEFAULT_EVENT_CARD_PRINTING_DATA.customFields.specimen,
          ...(parsed.customFields?.specimen || {}),
        },
      },
      eventTypes: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.eventTypes,
        ...(parsed.eventTypes || {}),
        types:
          Array.isArray(parsed.eventTypes?.types) && parsed.eventTypes.types.length > 0
            ? parsed.eventTypes.types
            : DEFAULT_EVENT_CARD_PRINTING_DATA.eventTypes.types,
      },
      attachment: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.attachment,
        ...(parsed.attachment || {}),
        option1: {
          ...DEFAULT_EVENT_CARD_PRINTING_DATA.attachment.option1,
          ...(parsed.attachment?.option1 || {}),
        },
        option2: {
          ...DEFAULT_EVENT_CARD_PRINTING_DATA.attachment.option2,
          ...(parsed.attachment?.option2 || {}),
        },
      },
      ultrasonic: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.ultrasonic,
        ...(parsed.ultrasonic || {}),
      },
      rightAttachment: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.rightAttachment,
        ...(parsed.rightAttachment || {}),
      },
      categories: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.categories,
        ...(parsed.categories || {}),
        categories:
          Array.isArray(parsed.categories?.categories) && parsed.categories.categories.length > 0
            ? parsed.categories.categories
            : DEFAULT_EVENT_CARD_PRINTING_DATA.categories.categories,
      },
      branding: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.branding,
        ...(parsed.branding || {}),
      },
      personalization: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.personalization,
        ...(parsed.personalization || {}),
      },
      bulk: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.bulk,
        ...(parsed.bulk || {}),
      },
      process: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.process,
        ...(parsed.process || {}),
        steps:
          Array.isArray(parsed.process?.steps) && parsed.process.steps.length > 0
            ? parsed.process.steps
            : DEFAULT_EVENT_CARD_PRINTING_DATA.process.steps,
      },
      solutions: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.solutions,
        ...(parsed.solutions || {}),
        solutions:
          Array.isArray(parsed.solutions?.solutions) && parsed.solutions.solutions.length > 0
            ? parsed.solutions.solutions
            : DEFAULT_EVENT_CARD_PRINTING_DATA.solutions.solutions,
      },
      comparison: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.comparison,
        ...(parsed.comparison || {}),
      },
      informationNeeded: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.informationNeeded,
        ...(parsed.informationNeeded || {}),
      },
      qualityChecks: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.qualityChecks,
        ...(parsed.qualityChecks || {}),
      },
      pricing: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.pricing,
        ...(parsed.pricing || {}),
      },
      whyChoose: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.whyChoose,
        ...(parsed.whyChoose || {}),
      },
      faq: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.faq,
        ...(parsed.faq || {}),
      },
      closingCta: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.closingCta,
        ...(parsed.closingCta || {}),
      },
      summaryBanner: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.summaryBanner,
        ...(parsed.summaryBanner || {}),
      },
      geographicDirectory: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.geographicDirectory,
        ...(parsed.geographicDirectory || {}),
      },
      metadata: {
        ...DEFAULT_EVENT_CARD_PRINTING_DATA.metadata,
        ...(parsed.metadata || {}),
      },
    };
  } catch (error) {
    console.error("Error reading dynamic event card printing data:", error);
    return DEFAULT_EVENT_CARD_PRINTING_DATA;
  }
}

export function saveDynamicEventCardPrinting(
