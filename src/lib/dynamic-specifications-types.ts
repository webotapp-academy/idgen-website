...
export interface TechnicalSpecItem {
  ...
  category: string;
  description?: string;
  priceFormula?: string; // "auto" or custom string e.g. "₹15 – ₹16 / card"
  matchedPricingIds?: string[];
  imageSrc: string;
  alt: string;
  imageTag?: string;
  pageHref: string;
...
export interface TechnicalSpecsSectionConfig {
  eyebrow: string;
  title: string;
  lede: string;
}

export const defaultSectionConfig: TechnicalSpecsSectionConfig = {
...
export const defaultTechnicalSpecs: TechnicalSpecItem[] = [
  {
    id: "pvc-id-cards",
    ...
    highlights: [
      "Water-Proof Solid Core",
      "Zero Corner De-lamination",
      "Edge-to-Edge 300+ DPI Print",
  ...
  },
  {
    ...
    highlights: [
      "Skin-Friendly Soft Weave",
      "Fray-Proof Ultrasonic Sealing",
      "Washable Fade-Resistant Colors",
  ...
  },
  {
    ...
    highlights: [
      "Turnstile & Door Lock Ready",
      "Tamper-Proof Embedded Chip",
      "High-Speed Contactless Scan",
      "Dual Frequency Custom Inlays",
    ],
    sortOrder: 3,
    isActive: true,
  },
  {
    ...
    highlights: [
      "High-Visibility Oversized Layout",
      "Anti-Twist Dual Hook Support",
      "Multi-Day Conference Durable",
      "Quick-Scan Delegate QR",
    ],
    sortOrder: 4,
    isActive: true,
  },
  {
    ...
    description: "Direct factory manufactured & quality inspected at IDGen cleanrooms.",
    priceFormula: "auto",
    matchedPricingIds: ["holder-v1", "holder-v2", "holder-h1", "holder-h2"],
    imageSrc: "/images/product-id-holders.jpg",
    alt: "Polycarbonate rigid card holder specifications for V-1, H-1, V-2",
    imageTag: "Protective Holders",
    pageHref: "/id-card-holders/",
    buttonText: "Get Quote",
    specs: [
      {
        label: "Available Models",
        value: "V-1 (Vertical Standard), H-1 (Horizontal), V-2 (4-Side Lock), H-2 (Landscape Lock)",
      },
    ...
    highlights: [
      ...
      "4-Corner Edge Guard Protection",
      "Thumb Slot Card Removal",
      "Prevents Bending & Snapping",
    ],
    sortOrder: 5,
    isActive: true,
  },
  ...
  },
  {
    ...
    highlights: [
      "Clothing-Safe Magnetic Clasp",
      "Zero Pin Hole Damage",
      "Glass-Like Depth & Gloss",
      "Personalized Names & Titles",
    ],
    sortOrder: 7,
    isActive: true,
  },
  {
    ...
    highlights: [
      "3D High-Relief Sculpted Artwork",
      "Heavy Premium Weight in Hand",
      "Custom Event & Institute Crest",
      "Matching Themed Satin Ribbon",
    ],
    sortOrder: 8,
    isActive: true,
  },
