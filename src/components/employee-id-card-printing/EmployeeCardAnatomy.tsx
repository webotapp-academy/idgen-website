...
const frontFields: CardFieldItem[] = [
  { id: "f1", name: "Company Logo", category: "front", icon: Building2, hint: "Official corporate emblem & branding" },
  { id: "f2", name: "Employee Photograph", category: "front", icon: User, hint: "High-resolution passport photograph" },
  { id: "f3", name: "Employee Name", category: "front", icon: User, hint: "Full official employee name" },
  { id: "f4", name: "Designation", category: "front", icon: Briefcase, hint: "Role / job title" },
  { id: "f5", name: "Employee ID", category: "front", icon: CreditCard, hint: "Unique alphanumeric staff code" },
];

const backFields: CardFieldItem[] = [
  { id: "b1", name: "Company information", category: "back", icon: Building2, hint: "Office address & registered details" },
  { id: "b2", name: "Emergency/contact information where required", category: "back", icon: Phone, hint: "Emergency phone & blood group" },
  { id: "b3", name: "QR code or barcode", category: "back", icon: QrCode, hint: "Machine-readable digital verification" },
  { id: "b4", name: "Terms or instructions", category: "back", icon: FileText, hint: "Cardholder responsibilities & return instructions" },
  { id: "b5", name: "Verification information", category: "back", icon: ShieldCheck, hint: "Authorized signatory / validity details" },
];
