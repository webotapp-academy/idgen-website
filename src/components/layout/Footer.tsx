        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 items-start border-b border-white/10 pb-12 mb-12">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li className="pt-1">
                <Link href="/service-areas/assam/" className="font-bold text-cyan-300 hover:underline">
                  Assam Hub &amp; Locations →
                </Link>
              </li>
            </ul>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              ...
              <a 
                href={SITE.social.linkedin || "https://www.linkedin.com/company/144808592/"}
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0A66C2] text-white hover:scale-110 active:scale-95 transition-all shadow-md shadow-blue-600/20"
                aria-label="LinkedIn"
                title="LinkedIn - IDGen"
              >
              ...
              {SITE.social.threads && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-900 border border-white/20 text-white hover:bg-black hover:scale-110 active:scale-95 transition-all shadow-md"
                  aria-label="Threads"
                  title="Threads - @idgenguwahati"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                    <path d="M12.186 20.448c-3.05 0-5.466-1.077-6.85-3.053-.948-1.353-1.336-3.048-1.121-4.912.355-3.078 2.37-5.59 5.393-6.721 1.545-.578 3.284-.694 4.897-.327 1.83.417 3.388 1.487 4.387 3.013 1.034 1.58 1.401 3.51.986 5.434-.415 1.924-1.577 3.535-3.272 4.537-1.42.84-3.072 1.183-4.652.966-1.58-.217-2.986-1.053-3.856-2.285l1.637-1.156c.594.84 1.554 1.41 2.632 1.558 1.078.148 2.203-.086 3.17-.659 1.156-.684 1.948-1.782 2.23-3.094.282-1.312.032-2.628-.673-3.707-.681-1.042-1.745-1.771-2.997-2.055-1.101-.25-2.289-.17-3.344.225-2.06.772-3.435 2.485-3.677 4.582-.147 1.272.118 2.427.764 3.35.945 1.348 2.597 2.083 4.653 2.083 1.135 0 2.281-.225 3.313-.65l.775 1.848c-1.32.544-2.784.829-4.238.829zm3.847-8.156c-.237.787-.723 1.464-1.397 1.936-.674.472-1.485.714-2.316.692-1.187-.03-2.247-.648-2.766-1.608-.519-.96-.46-2.127.155-3.036.615-.909 1.696-1.464 2.812-1.444 1.116.02 2.148.614 2.686 1.549.378.658.468 1.425.26 2.133l.566.178z"/>
                  </svg>
                </a>
              )}
              {SITE.social.twitter && (
              ...
              {SITE.social.pinterest && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E60023] text-white hover:scale-110 active:scale-95 transition-all shadow-md shadow-red-600/20"
                  aria-label="Pinterest"
                  title="Pinterest - iDGenGuwahati"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4.5 w-4.5">
              ...
              {SITE.social.whatsappChannel && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[#128C7E] text-white hover:scale-110 active:scale-95 transition-all shadow-md shadow-emerald-600/20"
