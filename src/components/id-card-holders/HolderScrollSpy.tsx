...
export const HOLDER_SECTIONS: SectionNav[] = [
  { id: "overview", label: "Overview", shortLabel: "Hero" },
  { id: "quick-holder-selection-system", label: "Quick Holder Selection System", shortLabel: "Selection Matrix" },
  { id: "holder-assembly-ecosystem", label: "Assembly Ecosystem", shortLabel: "Assembly" },
  { id: "holder-catalog", label: "Holder Catalog", shortLabel: "Catalog" },
  { id: "engineering-guide", label: "Engineering Guide", shortLabel: "Engineering" },
  { id: "applications", label: "Applications", shortLabel: "Applications" },
  { id: "workflow-dispatch", label: "Workflow & Dispatch", shortLabel: "Workflow" },
  { id: "faq", label: "FAQ", shortLabel: "FAQ" },
];

/**
 * Client-side Scroll Spy & Dynamic URL Hash Generator for ID Card Holders
 * Listens to scrolling and dynamically updates the browser address bar
 * with history.replaceState so that `#quick-holder-selection-system` is generated as you scroll down.
 */
export function HolderScrollSpyNav() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      let current = HOLDER_SECTIONS[0].id;
      for (const section of HOLDER_SECTIONS) {
