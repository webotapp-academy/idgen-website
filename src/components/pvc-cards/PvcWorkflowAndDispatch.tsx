...
export function PvcWorkflowAndDispatch() {
  return (
    <div className="space-y-16 sm:space-y-20 mt-16 sm:mt-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-6 border-b border-slate-200/90 dark:border-slate-800">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mt-2">
              How We Print &amp; Encode PVC Cards
            </h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 max-w-2xl">
              From data roster matching and color proofing to thermal dye-sublimation and anti-static tray packaging.
            </p>
          </div>
        </div>
      ...
      <div className="rounded-3xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-8 lg:p-10 shadow-xl space-y-6">
        ...
        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl font-normal">
          For standard organizational ID batches with approved data rosters, our automated thermal production line operates on a strict factory fulfillment schedule:
        </p>

        <div className="pt-2">
          <FlowChain steps={["Roster Data Merge", "300 DPI Dye Sublimation", "Protective Overcoating", "Automated Sequence Sort", "Anti-Static Dispatch"]} />
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div className="max-w-3xl space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
              Ready to Order CR80 Virgin PVC Cards?
            </h2>
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-normal">
              Whether you need 100 printed student ID cards or 50,000 blank Mifare smart cards for an enterprise campus, IDGen delivers factory-direct rates from Guwahati.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            >
              <span>Compatible ID Card Holders</span>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-[11px] text-slate-400">
            <p className="font-mono text-slate-300">
              IDGen — 30-Mil CR80 Virgin PVC Smart Cards &amp; Credentials
            </p>
